...
class CoD(object):
    ...
    def get_dirout(self, model, scenario, region, season, predictant):
    ...
    def get_cod_file_path(self, model, scenario, region, season, predictant):
        return os.path.join(self.get_dirout(model, scenario, region, season, predictant),
    ...
    def read_cod(self, model, scenario, region, season, predictant):
        """ Given the model, scenario, region, season, predictant, locate the CoD file path and read its content
        """
        return CoD.read(self.get_cod_file_path(model, scenario, region, season, predictant))
...
if __name__ == '__main__':
    ...
    ap.add_argument('-r', '--region', required=True, help='pre-defined region name, e.g. sea, sec, tas ...')
    ...
    print CoD(ns.base_dir).get_cod_file_path(ns.model, ns.scenario, ns.region, ns.season, ns.predictand)
